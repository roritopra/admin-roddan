    ...
    <main className="flex flex-col w-full px-6 bg-[#F9FAFB]">
      ...
      <section className="dashboard-grid">
        <div className="div1 bg-white p-6">
          <div>
            <h2 className="font-satoshi text-[#151D48] text-lg font-semibold">
              Today’s Sales
            </h2>
            <p className="font-satoshi text-[#737791] text-sm mt-2">
              Sales Summery
            </p>
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-7">
              ...
              >
                ...
                <p className="font-satoshi text-[#425166] text-4xl mt-2">
                  $3,493
                </p>
                <NavLink
                  to={"/orders"}
